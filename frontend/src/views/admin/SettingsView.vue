      ...
      <form v-else @submit.prevent="saveSettings" class="space-y-6" novalidate>
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              <template v-else>
                <div class="flex items-center justify-between">
                  <div>
                    <label class="font-medium text-content-strong">{{
              ...
              <template v-else>
                ...
                >
                  <div class="mb-3 flex items-center gap-2">
                    <span
                      class="text-sm font-medium text-content-strong"
                    >
                  ...
                  <div class="mt-3">
                    ...
                    <p class="mb-2 text-xs text-content-subtle">
          ...
          <div class="card">
            ...
            <div class="space-y-5 p-6">
              ...
              >
                ...
                <div
                  class="mb-4 flex flex-wrap items-center gap-x-2 gap-y-1 text-xs text-content-muted"
                ...
                >
                  ...
                  <p
                    ...
                    class="mb-2 text-xs text-content-subtle"
                  >
                    {{
                ...
                >
                  <div class="flex flex-wrap items-center gap-2">
                    ...
                    >
                      ...
                      <button
                        type="button"
                        class="rounded-full text-gray-500 hover:bg-gray-200 hover:text-content dark:hover:bg-dark-500 dark:hover:text-white"
                        @click="
                ...
                <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-700">
                  ...
                  <div v-if="form.github_oauth_enabled" class="mt-4 space-y-4">
                    ...
                    <div class="grid grid-cols-1 gap-4 lg:grid-cols-2">
                      <div>
                        <label class="mb-2 block text-sm font-medium text-content">Client ID</label>
                        <input
                      ...
                      <div>
                        <label class="mb-2 block text-sm font-medium text-content">Client Secret</label>
                        <input
                ...
                <div class="grid grid-cols-1 gap-6">
                  ...
                  >
                    ...
                    <div v-if="form.dingtalk_connect_sync_display_name" class="space-y-2">
                      <div class="flex items-center gap-2">
                        <label class="text-sm text-content-muted whitespace-nowrap min-w-[5rem]">
                    ...
                    <p v-if="form.dingtalk_connect_sync_display_name" class="text-xs text-content-subtle">
                  ...
                  >
                    ...
                    <p v-if="form.dingtalk_connect_sync_corp_email" class="text-xs text-content-subtle">
                  ...
                  >
                    ...
                    <p v-if="form.dingtalk_connect_sync_dept" class="text-xs text-content-subtle">
                  ...
                  <table class="min-w-full text-sm">
                    ...
                    <tbody class="space-y-2">
                      <tr v-for="p in (['anthropic', 'openai', 'gemini', 'antigravity', 'grok'] as const)" :key="p" class="align-top">
                        <td class="pr-4 py-1">
                          <span class="font-mono text-xs text-content">{{ p }}</span>
                        </td>
                        <td class="pr-4 py-1">
                          <input
        ...
        <div v-show="activeTab === 'gateway'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="p-6 space-y-4">
                ...
                <div>
                  ...
                  <p class="mb-2 mt-1 text-xs text-content-muted">
                ...
                <div>
                  ...
                  >
                    ...
                    />
                    <label
                      class="flex shrink-0 items-center gap-1 text-xs text-content-muted"
                      :title="
                        t(
            ...
            <div class="space-y-5 p-6">
              ...
              <template v-else>
                ...
                <div v-if="ollamaCloudUsageForm.enabled" class="space-y-4 border-t border-gray-100 pt-4 dark:border-dark-700">
                  <div>
                    <label class="mb-2 block text-sm font-medium text-content" for="ollama-cloud-usage-debounce">
                  ...
                  <div>
                    <label class="mb-2 block text-sm font-medium text-content" for="ollama-cloud-usage-interval">
                ...
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
                  ...
                  >
                    <div class="flex items-start justify-between gap-3">
                      <div>
                        <label
                          class="font-mono text-sm font-medium text-content-strong"
                        >
                          {{ platform }}
                        </label>
                        <p class="mt-0.5 text-xs text-content-muted">
              ...
              <div class="grid gap-5 border-b border-gray-100 pb-5 dark:border-dark-700 md:grid-cols-[minmax(0,1fr)_auto] md:items-end">
                ...
                <div class="flex items-center justify-between gap-5 md:min-w-72">
                  <div>
                    ...
                    <p class="mt-0.5 max-w-sm text-xs text-content-muted">
                    ...
                    <div v-show="block.expanded">
                      ...
                      >
                        <div class="flex items-center justify-between gap-4">
                          <div>
                            <label
                              class="text-xs font-medium text-content-muted"
                            >
                              {{
                                t(
            ...
            <div class="space-y-5 p-6">
              ...
              <div v-if="webSearchConfig.enabled" class="space-y-4">
                ...
                <div
                  ...
                  :key="pIdx"
                  class="rounded-lg border border-line-strong"
                >
                  <!-- Collapsible header -->
                  <div
                    ...
                    <div>
                      ...
                      <div class="relative">
                        ...
                        >
                          <button
                            type="button"
                            class="rounded p-1 text-gray-400 hover:text-content"
                            :title="
                              apiKeyVisible[pIdx]
                                ? t(
          ...
          >
            ...
            >
              <h3
                class="mb-4 text-lg font-semibold text-content-strong"
              >
        ...
        <div v-show="activeTab === 'general'" class="space-y-6">
          ...
          <div class="card">
            ...
            <div class="space-y-6 p-6">
              ...
              >
                <div>
                  <h3 class="text-sm font-medium text-content-strong">
        ...
        <div class="card">
          ...
          <div class="space-y-5 p-6">
            ...
            <div v-if="form.model_plaza_enabled">
              ...
              <p class="mb-2 mt-0.5 text-xs text-content-muted">
          ...
          <div class="space-y-5 p-6">
            ...
            <div v-if="form.affiliate_enabled" class="space-y-6">
              ...
              <div class="border-t border-gray-100 pt-6 dark:border-dark-700">
                ...
                <div class="overflow-x-auto rounded-lg border border-line-subtle">
                  <table class="min-w-full divide-y divide-line-subtle">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-900">
                      ...
                      <tr v-for="entry in affiliateState.entries" :key="entry.user_id">
                        ...
                        <td class="px-3 py-2 text-sm text-content-strong">{{ entry.email }}</td>
                        <td class="px-3 py-2 text-sm text-content-muted">{{ entry.username }}</td>
          ...
          <div class="w-full max-w-md rounded-lg bg-white p-6 shadow-xl dark:bg-dark-900">
            ...
            <div class="space-y-4">
              <div v-if="affiliateModal.mode === 'add'">
                ...
                >
                  <div class="text-sm">
                    <span class="font-medium text-content-strong">{{ affiliateModal.selectedUser.email }}</span>
                ...
                <template v-else>
                  ...
                  <div
                    ...
                    class="mt-1 max-h-40 overflow-y-auto rounded border border-line-subtle"
                  >
                    <button
                      v-for="u in affiliateModal.userResults"
                      :key="u.id"
                      type="button"
                      class="w-full px-3 py-1.5 text-left text-sm hover:bg-surface-sunken"
        ...
        <div v-show="activeTab === 'email'" class="space-y-6">
            ...
            <div class="p-6">
              <div class="flex items-start gap-3">
                <Icon
                  name="mail"
                  size="md"
                  class="mt-0.5 flex-shrink-0 text-content-subtle"
                />
                <div>
                  <h3 class="font-medium text-content-strong">
          ...
          <div class="card">
            <div
              class="border-b border-gray-100 px-6 py-4 dark:border-dark-700"
            >
              <h3 class="text-base font-medium text-content-strong">
            ...
            <div class="px-6 py-6">
              <div class="flex items-center justify-between gap-4">
                <div>
                  <label
                    class="mb-0 block text-sm font-medium text-content"
                  >
