    ...
    <div class="custom-page-layout">
      <div class="card flex-1 min-h-0 overflow-hidden">
        ...
        >
          <div class="max-w-md">
            <div
              class="mx-auto mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-surface-sunken"
            >
...
.toc-sidebar {
  @apply flex flex-col h-full border-r border-line-strong bg-surface-sunken;
  width: min(240px, 30%);
  min-width: 160px;
  max-width: 280px;
  overflow: hidden;
...
.toc-header {
  @apply flex items-center justify-between px-4 py-3 border-b border-line-strong;
}
...
.toc-close-btn {
  @apply p-1 rounded text-gray-400 hover:text-gray-600 dark:hover:text-dark-200 hover:bg-surface-sunken transition-colors;
}
...
.toc-item {
  ...
  @apply text-content-muted hover:text-content-strong hover:bg-surface-sunken;
}
...
.toc-toggle-btn {
  ...
  @apply text-content-muted hover:bg-gray-100 dark:hover:bg-dark-600;
...
.markdown-page-content h1 { @apply text-3xl font-bold mt-8 mb-4 pb-2 border-b border-line-strong; }
...
.markdown-page-content blockquote { @apply border-l-4 border-line-strong pl-4 italic text-content-muted my-4; }
...
.markdown-page-content th { @apply border border-line-strong px-3 py-2 bg-surface-sunken font-semibold text-left; }
.markdown-page-content td { @apply border border-line-strong px-3 py-2; }
.markdown-page-content code { @apply bg-surface-sunken px-1.5 py-0.5 rounded text-sm font-mono; }
...
.markdown-page-content hr { @apply my-6 border-line-strong; }
