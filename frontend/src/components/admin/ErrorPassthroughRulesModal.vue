      ...
      <div v-else class="max-h-96 overflow-auto rounded-lg border border-line-strong">
        <table class="min-w-full divide-y divide-line-subtle">
          ...
          <tbody class="divide-y divide-gray-200 bg-white dark:divide-dark-700 dark:bg-dark-800">
            <tr v-for="rule in rules" :key="rule.id" class="hover:bg-surface-sunken">
              ...
              <td class="px-3 py-2">
                <div class="font-medium text-content-strong text-sm">{{ rule.name }}</div>
                <div v-if="rule.description" class="mt-0.5 text-xs text-content-muted max-w-xs truncate">
                  {{ rule.description }}
                </div>
              </td>
              <td class="px-3 py-2">
              ...
              <td class="px-3 py-2">
                <div v-if="rule.platforms.length === 0" class="text-xs text-content-muted">
    ...
    >
      <form @submit.prevent="handleSubmit" class="space-y-4">
        ...
        <div class="rounded-lg border border-gray-200 p-3 dark:border-dark-600">
          <h4 class="mb-2 text-sm font-medium text-content-strong">
          ...
          <div class="mt-3">
            ...
            <div class="flex flex-wrap gap-3">
              ...
              >
                ...
                />
                <span class="text-xs text-content">{{ platform.label }}</span>
              </label>
            </div>
