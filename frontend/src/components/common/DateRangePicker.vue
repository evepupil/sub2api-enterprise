      ...
      <div v-if="isOpen" class="date-picker-dropdown">
        ...
        <div class="date-picker-custom">
          ...
          <div class="date-picker-separator">
            <Icon name="arrowRight" size="sm" class="text-content-subtle" />
          </div>
          <div class="date-picker-field">
...
<style scoped>
.date-picker-trigger {
  @apply flex h-[34px] cursor-pointer items-center gap-2;
  @apply rounded-lg px-3 text-sm;
  @apply border border-line-strong bg-surface-raised text-content;
...
.date-picker-dropdown {
  @apply absolute left-0 z-[100] mt-1.5 min-w-[320px] overflow-hidden;
...
.date-picker-preset {
  @apply rounded-lg px-3 py-1.5 text-xs font-medium text-content-muted;
  @apply transition-colors duration-150 hover:bg-surface-sunken hover:text-content-strong;
}

.date-picker-preset-active {
  @apply bg-primary-50 text-primary-700 dark:bg-primary-500/15 dark:text-primary-300;
  @apply hover:bg-primary-50 hover:text-primary-700 dark:hover:bg-primary-500/15;
}
...
.date-picker-label {
  @apply mb-1 block text-xs font-medium text-content-muted;
}

.date-picker-input {
  @apply h-[30px] w-full rounded-lg px-2.5 text-sm;
