      ...
      <template v-else-if="stats">
        ...
        <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
          ...
          >
            ...
            <p class="text-2xl font-bold text-content-strong">
          ...
          <div class="card p-4">
            ...
            <div class="space-y-2">
              <div class="flex items-center justify-between">
                <span class="text-xs text-content-muted">{{ t('usage.accountBilled') }}</span>
                <span class="text-sm font-semibold text-content-strong"
                  >${{ formatCost(stats.summary.today?.cost || 0) }}</span
                >
              </div>
              <div class="flex items-center justify-between">
                <span class="text-xs text-content-muted">{{ t('usage.userBilled') }}</span>
                <span class="text-sm font-semibold text-content-strong"
