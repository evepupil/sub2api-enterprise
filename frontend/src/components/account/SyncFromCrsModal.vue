  ...
  >
    ...
    <div v-else-if="currentStep === 'preview' && previewResult" class="space-y-4">
      ...
      <div v-if="previewResult.new_accounts.length">
        <div class="mb-2 flex items-center justify-between">
          ...
          <div class="flex gap-2">
            ...
            <button
              type="button"
              class="text-xs text-gray-500 hover:text-content-muted"
              @click="selectNone"
        ...
        >
          <label
            ...
            :key="acc.crs_account_id"
            class="flex cursor-pointer items-center gap-2 rounded px-2 py-1.5 hover:bg-surface-sunken/40"
          >
            <input
              type="checkbox"
            ...
            >{{ acc.platform }} / {{ acc.type }}</span>
            <span class="truncate text-sm text-content">{{ acc.name }}</span>
          </label>
        </div>
      ...
      <div class="flex items-center gap-2 text-xs text-content-muted">
        ...
        <span :class="form.sync_proxies ? 'text-green-600 dark:text-green-400' : 'text-content-subtle'">
