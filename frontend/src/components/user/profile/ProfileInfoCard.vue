          ...
          <div class="min-w-0 flex-1 space-y-5">
            <div class="space-y-3">
              <div class="flex flex-wrap items-center gap-2">
                <h2 class="truncate text-2xl font-semibold text-content-strong">
                  {{ displayName }}
                </h2>
              ...
              <div class="space-y-1">
                ...
                <div
                  ...
                  class="flex flex-wrap gap-2 text-xs text-content-muted"
                >
                  <span
            ...
            <div class="grid gap-3 sm:grid-cols-3">
              ...
              >
                <p class="text-xs font-medium uppercase tracking-[0.16em] text-content-subtle">
                  {{ t('profile.accountBalance') }}
                </p>
                <p class="mt-1 text-lg font-semibold text-content-strong">
      ...
      <div data-testid="profile-side-column" class="space-y-6">
        ...
        >
          ...
          <div class="mt-5 grid gap-3">
            ...
            >
              <Icon name="link" size="sm" class="mt-0.5 text-content-subtle" />
              <span>{{ hint.text }}</span>
            </div>
          </div>
        </section>
