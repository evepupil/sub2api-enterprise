<template>
  <div class="mt-4 pt-3 border-t border-line-subtle/60">
    <div
    ...
    <div
      v-if="maintenance"
      class="flex h-5 w-full items-center justify-center rounded border border-dashed border-line-strong text-[10px] uppercase tracking-widest text-gray-400"
    >
